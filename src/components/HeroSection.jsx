...
import { FaReact, FaGithub, FaLinkedinIn, FaWhatsapp, FaVideo, FaRocket, FaFileAlt } from 'react-icons/fa';
...
export const HeroSection = ({ onOpenBooking }) => {
  ...
  return (
    <section className="relative pt-24 lg:pt-32 pb-12 lg:pb-16 flex flex-col items-center justify-center px-6 lg:px-16 gap-10 max-w-7xl mx-auto w-full overflow-hidden">
      ...
      <div className="w-full flex flex-col lg:flex-row items-center justify-center gap-10 lg:gap-12">
        ...
        <motion.div
          ...
          className="flex-1 w-full text-left space-y-8 order-2 lg:order-1 relative z-10 lg:pt-2"
        >
        ...
        >
          <div className="relative w-[250px] h-[250px] xs:w-[290px] xs:h-[290px] sm:w-[420px] sm:h-[420px] perspective-1000">
            ...
            <motion.div 
              className="relative z-10 w-full h-full p-6 sm:p-10 transition-transform duration-500 hover:scale-[1.02]"
            >
      ...
      {/* Bottom Discover */}
      <div className="mt-6 lg:mt-8 hidden lg:flex flex-col items-center gap-2 opacity-60 hover:opacity-100 transition-opacity cursor-pointer" onClick={handleScrollDown}>
        <span className="text-[10px] font-black uppercase tracking-[0.3em] text-slate-500">Scroll Down</span>
        <motion.div animate={{ y: [0, 6, 0] }} transition={{ duration: 1.5, repeat: Infinity }} className="w-5 h-8 rounded-full border-2 border-slate-400 flex justify-center p-1">
